...
class LightnessClientViewHolder(private val layout: DevicesAdapterDefaultBinding, deviceListLogic: DeviceListAdapterLogic)
    ...
    override fun bindView(meshNode: MeshNode, isNetworkConnected: Boolean) {
        ...
        layout.apply {
            ...
            if (!isNetworkConnected) {
                devicesAdapterBaseHeader.ivDeviceImage.setImageResource(R.drawable.toggle_off)
            } else {
                devicesAdapterBaseHeader.ivDeviceImage.setImageResource(R.drawable.toggle_on)
            }
        }
